...
<div class="content table-responsive table-full-width">
    <table id="expenseCategoryTable" class="table table-hover table-striped">
        ...
        foreach ($rows as $row) {
           ...
           if($status=="Accepted") $html.= '<td><span style="color: green">Accepted</span></td>';
            else if($status=="Rejected") $html.= '<td><span style="color: red">Rejected</span></td>';
             else if($status==1) $html.= '<td><span style="color: orange">Pending</span></td>';
