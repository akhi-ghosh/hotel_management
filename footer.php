...
<footer class="footer-ref" style="background-color: #24292e;padding-top: 15px;width: 100%;padding-left: 20px;position:fixed;bottom: 0;left:0">
    <div class="container"">
        <div class="row">
        ...
        <div class="col-md-2 text-left col-md-offset-1">
            <p><a class="footer-ref" href="#" >Copyright @Akhi Ghosh</a></p>

        </div>
        <div class="col-md-2 text-left col-md-offset-1">
            <p><a class="footer-ref" href="#" >About the library</a></p>
            <p><a class="footer-ref" href="#construct" >Terms of use</a></p>
